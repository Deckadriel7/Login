...
namespace FindMyGym.Models
{
    ...
    public partial class BD_FindMyGymEntities : DbContext
    {
        ...
        public virtual int sp_InsertarAcceso(string correo, string contrasenia, Nullable<int> id_login)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_InsertarAcceso", correoParameter, contraseniaParameter, id_loginParameter);
        }
